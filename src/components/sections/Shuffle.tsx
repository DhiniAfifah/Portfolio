...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // If ScrollTrigger is available we still create it for scroll-based triggering,
      // but also call create() immediately so the text is visible on initial load.
      try {
      ...
      // Ensure animation runs immediately (useful for above-the-fold headings)
      create();
  ...
  const Tag: React.ElementType = (tag || "p") as React.ElementType;
